        """
        Data Profiler Lxkaye
        ====================
        Open-source data utility that transforms tabular data across multiple formats.
...
def _write_output(rows: list, path: Path, suffix: str) -> None:
    ...
    if suffix == ".csv" and rows:
        ...
        def build_parser() -> argparse.ArgumentParser:
            p = argparse.ArgumentParser(prog=APP_NAME, description="Open-source data utility that transforms tabular data across multiple formats.")
